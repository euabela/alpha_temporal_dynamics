...
%   on original code by  Mike X. Cohen (mikexcohen.com).
%
% INPUT
% - Preprocessed EEG data in FieldTrip format
%
% OUTPUT
% - nbmap: narrow-band component topography
% - nbts:  narrow-band component time series
% - nbeeg: reconstructed EEG
%
% DEPENDENCIES
% - SPM12
%
...
% Narrow-band covariance for frequency of interest
%--------------------------------------------------------------------------
